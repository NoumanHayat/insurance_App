...
const ClaimSaved = ({ navigation, route }) => {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.upperPlane}>
                    ...
                    <Animated.Text style={[styles.message, messageStyles]}>
                        Find your saved claim under “Recent Claims” on the Policy Detail screen for the associated vehicle.
                    </Animated.Text>
                    <Animated.Text style={[styles.message, messageStyles]}>
                        Saved claims must be submitted within 30 days.
                    </Animated.Text>
                </View>
