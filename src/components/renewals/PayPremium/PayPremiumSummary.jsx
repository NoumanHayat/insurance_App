...
const PayPremiumSummary = ({ chosenBenefits, chosenPaymentPlan, prevPremium, risks, fullPaymentType, paymentMethod, cardType, cardLastFourDigitsCheck }) => {
            ...
            <View style={styles.cardSection}>
                ...
                <View style={[styles.data, styles.benefitData]}>
                    ...
                    <DataPoint
                        ...
                        label="Premium Total"
                        value={<Currency value={chosenPaymentPlan?.payment_term_premium} />}
                    />
                </View>
            </View>
            <View style={styles.lineBar} />
            <View style={styles.cardSection}>
                ...
                <View style={[styles.data, styles.paymentData]}>
                    ...
                    />
                        ...
                        <DataPoint
                            label={`Payment ${chosenPaymentPlan?.payment_number} of ${chosenPaymentPlan?.payment_terms_number}`}
                            value={<Currency value={chosenPaymentPlan?.payment_term_premium} />}
                        />
...
export default PayPremiumSummary;
