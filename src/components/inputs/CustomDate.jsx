...
const CustomDate = ({ pageColour, date, setDate, dob }) => {
...
const Content = ({ date, setDate, dob }) => {
	...
	// console.log(`Today: ${moment(currentDate).format("YYYY-MM-DD")}`)
	// console.log(`Typeof Today: ` + typeof currentDate)


	// console.log(`Date: ${selectedDate}`)
	// console.log(`Typeof Date: ` + typeof Date.parse(date))
		...
		<View style={styles.container}>
			<View style={styles.input}>
				...
				<DatePicker
					...
					format="MMMM D YYYY"
					// minDate={new Date("1900-05-31")}
					minDate={moment(today).format("YYYY-MMMM-DD")}
					maxDate="2030-03-31"
